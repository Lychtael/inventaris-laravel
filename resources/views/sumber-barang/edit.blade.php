        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3>Formulir Edit Sumber Barang</h3>
                    <hr class="my-3">
                    <form action="{{ route('sumberbarang.update', $sumberBarang->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_sumber') is-invalid @enderror" 
                                   id="nama_sumber" name="nama_sumber" value="{{ old('nama_sumber', $sumberBarang->nama_sumber) }}" required>
